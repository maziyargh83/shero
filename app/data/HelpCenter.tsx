        ...
        component: () => {
          return (
            <Fragment>
              ...
              <DownloadIcon image="PWA" className="my-10" />
            </Fragment>
          );
        },
      },
      ...
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                با وارد شدن به صفحه «ویرایش پروفایل» امکان ویرایش «نام»،‌ «تاریخ
                تولد»،‌ «قد»،‌ «وزن»، «طول پریود» و «سیکل پریود» برای شما وجود
                دارد. دقت کنید که امکان ویرایش «شماره موبایل» وجود ندارد و در
                صورت نیاز به تغییر آن یا اکانت جدید بسازید یا در صورت نیاز به
                حفظ اطلاعات قبلی‌تان با پشتیبانی لونا تماس بگیرید.{" "}
              </p>
            </Fragment>
          );
        },
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ویرایش «طول دوره»،‌ روی فیلد طول دوره کلیک کرده و عدد طول
                دوره مورد نظر خود را انتخاب کنید. در صورت منظم بودن طول دوره‌تان
                روز تب «منظم» کلیک کنید و یک عدد برای طول دوره انتخاب کنید.در
                صورت نامنظم بودن طول دوره‌تان روی تب «نامنظم» کلیک کنید و حداقل
                و حداکثر تعداد روزهای دوره‌تان را مشخص کنید. سپس دکمه «ثبت» را
                بزنید تا طول دوره دلخواه جدید ذخیره شود.
              </p>
            </Fragment>
          );
        },
...

      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ویرایش «طول پریود»،‌ روی فیلد طول پریود کلیک کرده و عدد طول
                پریود مورد نظر خود را انتخاب کنید و سپس دکمه «ثبت» را بزنید تا
                طول پریود دلخواه جدید ذخیره شود. (طول پریود به تعداد روزهای
                خونریزی شما در طول دوره‌تان گفته می‌شود که معمولا بین ۴ تا ۹ روز
                است).
              </p>
            </Fragment>
          );
      ...
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت تست BBT لازم است که دمای بدن خود را در روزهای مورد نظر
                قبل از برخاستن از خواب اندازه بگیرید و آن را مطابق عکس در فیلد
                دما وارد کنید. هم‌چنین ساعتی که دمای بدن خود را اندازه گرفتید هم
                وارد کنید و در صورتی که تغییر محسوسی در دمای بدن شما ایجاد شده
                بود در قسمت «امروز تغییر دمای بدنم بیشتر بود» تیک بزنید. در صورت
                نیاز می‌توانید برای خودتان یادداشت هم بنویسید. پس از وارد کردن
                این اطلاعات با زدن دکمه «اضافه کردن»، اطلاعات مورد نظر شما در
                روزی که انتخاب کرده بودید ذخیره می‌شود. با وارد کردن منظم این
                تست می‌توانید تخمین دقیق‌تری از روز تخمک‌گذاری خود داشته باشید.
              </p>
            </Fragment>
          );
        },
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت تست LH لازم است که پس از انجام تست، آیکون‌ تصویری که به
                نتیجه تست شما نزدیک‌تر است را مطابق شکل زیر انتخاب کنید و
                هم‌چنین ساعت انجام تست را هم وارد کنید. پس از وارد کردن این
                اطلاعات با زدن دکمه «اضافه کردن»، اطلاعات مورد نظر شما در روزی
                که انتخاب کرده بودید ذخیره می‌شود.
              </p>
            </Fragment>
          );
        },
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت اطلاعات پریود دقت کنید که روزی که انتخاب کرده‌اید از
                روزهایی باشد که در آن پریودی ثبت کرده‌اید. در غیر این صورت با
                پیام خطا مطابق تصویر مواجه می‌شوید. چنانچه روز انتخابی شما از
                روزهای پریودتان باشد، وارد صفحه «اطلاعات پریود» مطابق با تصویر
                می‌شوید و می‌توانید «رنگ خون»، «میزان خونریزی»، «میزان درد» و
                «میزان لختگی خون» را انتخاب کنید و در صورت نیاز یادداشتی
                بنویسید. پس از وارد کردن این اطلاعات با زدن دکمه «اضافه کردن»،
                اطلاعات مورد نظر شما در روزی که انتخاب کرده بودید ذخیره
                می‌شود(روز انتخابی شما بالای صفحه سمت چپ نمایش داده شده است).
              </p>
            </Fragment>
          );
        },
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت رابطه جنسی، نوع رابطه جنسی را انتخاب کنید. در صورتی که
                زمان آن را به یاد دارید روی تب «یادم میاد» کلیک کنید و زمان مورد
                نظر خود را انتخاب کنید. در غیر این صورت تب « یادم نمیاد» را
                بزنید. در صورت نیاز یادداشتی بنویسید. پس از وارد کردن این
                اطلاعات با زدن دکمه «اضافه کردن»، اطلاعات مورد نظر شما در روزی
                که انتخاب کرده بودید ذخیره می‌شود(روز انتخابی شما بالای صفحه سمت
                چپ نمایش داده شده است).
              </p>
            </Fragment>
          );
        },
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت لکه‌بینی، پس از ورود به صفحه لکه‌بینی می‌توانید «رنگ
                لکه» و «میزان خونریزی» را از بین گزینه‌های موجود انتخاب کنید. در
                صورت نیاز یادداشتی بنویسید. پس از وارد کردن این اطلاعات با زدن
                دکمه «اضافه کردن»، اطلاعات مورد نظر شما در روزی که انتخاب کرده
                بودید ذخیره می‌شود(روز انتخابی شما بالای صفحه سمت چپ نمایش داده
                شده است).
              </p>
            </Fragment>
          );
      ...
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت ترشحات واژن، پس از ورود به صفحه ترشحات واژن می‌توانید
                «بافت ترشح»، «میزان خونریزی» و «علائم قابل توجه» را از بین
                گزینه‌های موجود انتخاب کنید. در صورت نیاز یادداشتی بنویسید. پس
                از وارد کردن این اطلاعات با زدن دکمه «اضافه کردن»، اطلاعات مورد
                نظر شما در روزی که انتخاب کرده بودید ذخیره می‌شود(روز انتخابی
                شما بالای صفحه سمت چپ نمایش داده شده است).
              </p>
            </Fragment>
          );
        },
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت وزن، پس از ورود به صفحه وزن می‌توانید عدد وزن خود را بر
                حسب کیلوگرم انتخاب کنید. در صورت نیاز یادداشتی بنویسید. پس از
                وارد کردن این اطلاعات با زدن دکمه «اضافه کردن»، اطلاعات مورد نظر
                شما در روزی که انتخاب کرده بودید ذخیره می‌شود(روز انتخابی شما
                بالای صفحه سمت چپ نمایش داده شده است).
              </p>
            </Fragment>
          );
        },
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت حال روحی، پس از ورود به این صفحه می‌توانید «حال روحی»
                خود را از بین گزینه‌های موجود انتخاب کنید. در صورت نیاز یادداشتی
                بنویسید. پس از وارد کردن این اطلاعات با زدن دکمه «اضافه کردن»،
                اطلاعات مورد نظر شما در روزی که انتخاب کرده بودید ذخیره
                می‌شود(روز انتخابی شما بالای صفحه سمت چپ نمایش داده شده است).
              </p>
      ...
      },
      {
        ...
        component: () => {
          return (
            <Fragment>
              <p className="text-lg font-normal text-gray-G6">
                برای ثبت علائم دیگر، پس از ورود به صفحه علائم می‌توانید «علائم
                رایج»، و علائم مربوط به «سر»، «بدن»، «شکم» و «ساير علائم» دیگر
                را از بین گزینه‌های موجود انتخاب کنید. در صورت نیاز یادداشتی
                بنویسید. پس از وارد کردن این اطلاعات با زدن دکمه «اضافه کردن»،
                اطلاعات مورد نظر شما در روزی که انتخاب کرده بودید ذخیره
                می‌شود(روز انتخابی شما بالای صفحه سمت چپ نمایش داده شده است).
              </p>
